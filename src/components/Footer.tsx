...
const Footer = () => {
  return <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden text-foreground py-16">
      {/* Background Pattern */}
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0" style={{
          backgroundImage: 'radial-gradient(circle at 25% 25%, rgba(var(--primary) / 0.1) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(var(--primary) / 0.08) 0%, transparent 50%)',
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#practice" className="text-muted-foreground hover:text-primary transition-colors">NAATI Practice</a></li>
              <li><a href="#mock-test" className="text-muted-foreground hover:text-primary transition-colors">Mock Tests</a></li>
              <li><a href="#course" className="text-muted-foreground hover:text-primary transition-colors">Courses</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground bg-inherit">AI-Powered Scoring</li>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  <img 
                    ...
                    style={{
                      filter: 'brightness(1.3) contrast(1.2) drop-shadow(0 0 20px rgba(255, 255, 255, 0.4)) drop-shadow(0 0 40px rgba(var(--primary), 0.3))'
                    }}
                  />
                  
                  {/* Enhanced Sparkle Effects */}
                  <div className="absolute -top-2 -right-2 w-3 h-3 bg-white rounded-full animate-ping opacity-80"></div>
                  <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-primary rounded-full animate-pulse opacity-90" style={{ animationDelay: '0.5s' }}></div>
                  <div className="absolute top-1/2 -left-3 w-1 h-1 bg-white rounded-full animate-ping opacity-70" style={{ animationDelay: '1s' }}></div>
                  <div className="absolute top-1/4 -right-3 w-1 h-1 bg-primary/90 rounded-full animate-pulse opacity-80" style={{ animationDelay: '1.5s' }}></div>
                </div>
              </div>
            </div>
